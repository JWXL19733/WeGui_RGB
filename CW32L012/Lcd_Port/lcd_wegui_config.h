...
#define STR_MCU_CLASS "CW32L0"
#define STR_MCU_MODEL "CW32L012C8"
...
//--------------------------2.选择一个GUI菜单交互方式-----------------------------
#define _DEMO_4KEY_PORT     (0) //4按键交互接口 "上","下","左","右" 对应文件cw32l012_wegui_4key_port.c
#define _DEMO_6KEY_PORT     (1) //6按键交互接口 "上","下","左","右","OK","BACK" 对应文件cw32l012_wegui_6key_port.c
#define _OTHER_PROJECT_PORT (2) //项目自定义交互接口
#define _NONE_KEY_PORT      (3) //没有按键接口
...
//非彩屏,默认使用1位色
	...
	#include "cw32l012_wegui_6key_port.h"
	...
	#include "cw32l012_wegui_4key_port.h"
	...
	#warning("no key_port.c")
	#define Wegui_Interface_port_Init() do{}while(0)
	#define Wegui_Interface_stick(ms) do{}while(0)
#else
	#warning("no key_port.c")
	#define Wegui_Interface_port_Init() do{}while(0)
