...
{
	//1.关闭SPI
	//SPI_Cmd(CW_SPI1, DISABLE);
	//CW_SPI1->CR2_f.EN = DISABLE;//寄存器操作
	
	//2.调整SPI参数
	//SPI_DataSizeConfig(CW_SPI1, SPI_DataSize_8b);
	REGBITS_MODIFY(CW_SPI1->CR1, SPIx_CR1_WIDTH_Msk, SPI_DataSize_8b);//寄存器操作
	
	//3.打开SPI
	//SPI_Cmd(CW_SPI1, ENABLE);
	//CW_SPI1->CR2_f.EN = ENABLE;//寄存器操作
}
...
static void Set_SPI_DataSize_16b()
{
	...
	//2.调整SPI参数
	//SPI_DataSizeConfig(CW_SPI1, SPI_DataSize_16b);
	REGBITS_MODIFY(CW_SPI1->CR1, SPIx_CR1_WIDTH_Msk, SPI_DataSize_16b);//寄存器操作
