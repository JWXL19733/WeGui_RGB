...
int32_t main(void)
{
    WWDT_InitTypeDef WWDT_InitStruct;
    ...
    SysTick_Config(SystemCoreClock / 1000); // 1ms systick节拍
    ...
    //------------------------------------------------------------
    // 初始化并运行WWDT
    // 131072 *(1/8MHz) = 16.4ms, 溢出时间 = (0x7F - 0x40) * 16384 * (1/8MHz) = 1.048s  
    WWDT_InitStruct.CounterValue = 0x7F;
    WWDT_InitStruct.PreOvInt     = DISABLE;
    WWDT_InitStruct.Prescaler    = WWDT_PRESCALER_DIV131072;
