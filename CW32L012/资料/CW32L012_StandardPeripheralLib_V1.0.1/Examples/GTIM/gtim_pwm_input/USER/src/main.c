...
int32_t main(void)
{
    ...
    printf("Please connect the PWM signal to pin PA06.\r\n");
    ...
    while (1)
    {
        ...
        {
            flagComplete = 0;
            printf("The positive pulse width of the PWM signal is %.4fus, and the period is %.4fus.\r\n", Width/96.0, Period/96.0);
        }
...
void SYSCTRL_Configuration(void)
{
    ...
    SYSCTRL_MCO_OUT(SYSCTRL_MCO_SRC_HCLK, SYSCTRL_MCO_DIV4096);   //PA04输出23.4375KHz波形，模拟测试信号
}
