...
int32_t main(void)
{
    ...
    // 初始化 VC 模块
    VC_InitStruct.div  = VC_DIV_3;    // (3+1)/8 = 1/2
    ...
    VC_InitStruct.inputNegative = VC_INPUT_IN3;    // 内部电阻分压
    VC_InitStruct.inputPositive = VC_INPUT_IN1;    // PA02
    VC_InitStruct.interruptMode = VC_INT_FALLING | VC_INT_RISING;
...
void LED_Init(void)
{
    ...
    GPIO_InitStruct.Pins = GPIO_PIN_9; //LED口为PB09
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
