...
int main(void)
{
    ...
    ADC_InitStructure.ADC_IN0.ADC_SampTime = ADC_SampTime9Clk;     // 9个采样周期+ 15个固定转换周期，共24个周期，48MHz ADCCLK条件下可达2MSa/s
    ...
    while (1)
    {
        ...
        valueAdc = ADC_GetConversionValue(CW_ADC1,0);
#endif
