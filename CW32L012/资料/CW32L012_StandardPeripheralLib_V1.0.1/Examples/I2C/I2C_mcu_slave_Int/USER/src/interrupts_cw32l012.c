...
/* External variables --------------------------------------------------------*/
/* USER CODE BEGIN EV */
extern uint8_t u8RegAddr[];
extern uint16_t u16LenReceived, u16LenSent;
extern uint8_t u8DataReceived[];
/* USER CODE END EV */
...
/******************************************************************************/
/* CW32L012 Peripheral Interrupt Handlers                                        */
...
/**
 * @brief This funcation handles DMACH12
 */
...
/**
 * @brief This funcation handles DMACH34
 */
...
/**
 * @brief This funcation handles CORDIC
 */
...
/**
 * @brief This funcation handles ADC1
 */
...
/**
 * @brief This funcation handles VC13
 */
...
/**
 * @brief This funcation handles VC24
 */
...
/**
 * @brief This funcation handles GTIM34
 */
...
/**
 * @brief This funcation handles BTIM3_HALLTIM
 */
...
void I2C1_IRQHandler(void)
{
    ...
    LPI2C_SlaveIRQHandler(CW_I2C1, u8RegAddr, I2C_REG_ADDR_16BIT, u8DataReceived, &u16LenReceived, &u16LenSent);
...
/**
 * @brief This funcation handles SPI23
 */
...
/**
 * @brief This funcation handles ADC2_DAC
 */
