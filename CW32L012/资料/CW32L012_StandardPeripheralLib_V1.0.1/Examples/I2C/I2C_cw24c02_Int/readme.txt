...
硬件资源：
          ...
          4. PB09(LED1)设置为PUSH-PULL输出

演示说明：
          1、初始化MCU I2C为主机接口，400KHz，使能I2C中断。提示：可以通过宏定义，支持8MHz HSI主频和100kHz I2C通信速率。
      ...
      并根据需要读取的字节数产生对应字节的时钟信号，最后发送STOP信号。
          4、数据写、读传输完成后，比较发送/接收数组，如果数据一致，则LED1亮，否则LED1灭。
