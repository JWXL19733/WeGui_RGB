...
int32_t main(void)
{
    ...
    __SYSCTRL_GPIOB_CLK_ENABLE();    //Open GPIOB Clk

    //set PB08 / PB09 as output
    ...
    while (1)
    {
        //-----------------------------------------------------------------------
        //以下调用函数法读写PIN
        if ( GPIO_ReadPin(CW_GPIOA, GPIO_PIN_0 ) )
        {
            GPIO_WritePin( CW_GPIOB, GPIO_PIN_8 | GPIO_PIN_9, GPIO_Pin_SET );
        }
        else
        {
