...
#include "cw32l012_digitalsign.h"
...
int32_t main(void)
{
    ...
    printf("The chip Type is %s\r\n", Chip_Type);
    printf("The chip has %d pins\r\n", Pin_Count);
    printf("The chip provides %d bytes FLASH\r\n",  Flash_Size);
    printf("The chip provides %d bytes SRAM\r\n", Ram_Size);
    printf("The chip UUID is");
    for (i = 0; i < 10; i++)
    {
        printf(" 0x%02X", Chip_Uid[i]);
    }
    printf("\r\n");
