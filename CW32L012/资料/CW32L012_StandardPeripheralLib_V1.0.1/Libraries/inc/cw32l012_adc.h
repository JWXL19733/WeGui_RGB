...
typedef struct
{
	uint8_t                     ADC_BaseSampTime;              /*ADC基础采样时间*/
...
/** @defgroup ADC_BaseSampleTime
  * @{
  */
#define ADC_BaseSampTime3Clk                     ((uint32_t)0x00000000)
#define ADC_BaseSampTime6Clk                     ((uint32_t)0x00000001)
#define ADC_BaseSampTime9Clk                     ((uint32_t)0x00000002)
#define ADC_BaseSampTime10Clk                    ((uint32_t)0x00000003)

#define IS_ADC_BaseSAMPLE_TIME(BaseSAMPLE_TIME)      ((BaseSAMPLE_TIME) <= 0x00000003)
