...
//#define LCD_RES_IO_Init() do{}while(0)
	
//#define LCD_RES_Clr() do{GPIO_ResetBits(GPIOA,GPIO_Pin_4);}while(0)//库函数操作IO
//#define LCD_RES_Set() do{GPIO_SetBits(GPIOA,GPIO_Pin_4);}while(0)//库函数操作IO
#define LCD_RES_Clr() do{GPIOA->BRR = GPIO_Pin_4;}while(0)//寄存器操作,节省函数调用时间
#define LCD_RES_Set() do{GPIOA->BSRR = GPIO_Pin_4;}while(0)//寄存器操作,节省函数调用时间
