...
inline void Set_SPI_DataSize_8b()
{
	//1.关闭SPI
...
inline void Set_SPI_DataSize_16b()
{
	//1.关闭SPI
	//SPI_Cmd(LCD_SPIx, DISABLE);//STM32F103无需关闭
...
/*--------------------------------------------------------------
  ...
  * 传入1: ms时间
  * 功能: 软件延时
  * 说明: 无需精准 weak类型 改自lcd_port_template.c
----------------------------------------------------------------*/
...
/*--------------------------------------------------------------
  * 名称: lcd_port_init()
  * 功能: 屏幕接口初始化
  * 说明: SPI 背光IO等 weak类型 改自lcd_port_template.c
----------------------------------------------------------------*/
...
/*--------------------------------------------------------------
  ...
  * 传入1: dat待发送的命令
  * 功能: 向屏幕发送1个命令 weak类型 改自lcd_port_template.c
----------------------------------------------------------------*/
...
/*--------------------------------------------------------------
  ...
  * 传入1: *p待发送的数组指针
  * 传入2: num发送数量
  * 功能: 向屏幕发送num个命令 weak类型 改自lcd_port_template.c
----------------------------------------------------------------*/
...
/*--------------------------------------------------------------
  ...
  * 说明: OLED屏幕移植接口例程 weak类型 改自lcd_port_template.c
----------------------------------------------------------------*/
...
/*--------------------------------------------------------------
  ...
  * 说明: 灰度OLED屏幕移植接口例程 weak类型 改自lcd_port_template.c
----------------------------------------------------------------*/
